...
namespace DB_course.Models
{
    ...
    public static class ConnectionBuilder
    {
        ...
        public static IConnection CreateMSSQLconnection(IConfiguration config)
        {
        ...
        public static IConnection CreateMSSQLconnection(IConfiguration config, string login, string password)
        {
            string connectionString = "";
            connectionString = config.GetConnectionString("Connection") ?? throw new Exception();
